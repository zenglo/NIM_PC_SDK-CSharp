...
namespace NIM
{
    ...
    public class NIMSDKCommonSetting
    {
        ...
        public NIMSDKLogLevel LogLevel { get; set; }
    ...
    public class NIMSDKPrivateServerSetting
    {
        /// <summary>
        ...
        public NIMSDKPrivateServerSetting()
        {
            RsaVersion = 0;
        }
    }

    public class NIMSDKConfig : NimUtility.NimJsonObject<NIMSDKConfig>
    {
        [Newtonsoft.Json.JsonProperty("global_config")]
        public NIMSDKCommonSetting CommonSetting { get; set; }
        ...
        public NIMSDKPrivateServerSetting PrivateServerSetting { get; set; }
