...
namespace NIM.DocTransition
{
    ...
    class DocTransNativeMethods
    {
        ...
        [DllImport(NIMGlobal.NIMNativeDLL, EntryPoint = "nim_doctrans_get_info", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIMGlobal.NIMNativeDLL, EntryPoint = "nim_doctrans_get_info_list", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIMGlobal.NIMNativeDLL, EntryPoint = "nim_doctrans_del_info", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void nim_doctrans_del_info(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))]string id,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))]string jsonExt, 
            nim_doctrans_opt_cb_func cb, IntPtr userData);

        [DllImport(NIMGlobal.NIMNativeDLL, EntryPoint = "nim_doctrans_get_source_file_url", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIMGlobal.NIMNativeDLL, EntryPoint = "nim_doctrans_get_page_url", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
