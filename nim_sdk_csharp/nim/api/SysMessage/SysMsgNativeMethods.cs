...
namespace NIM.SysMessage
{
    ...
    class SysMsgNativeMethods
    {
        ...
        [DllImport(NIMGlobal.NIMNativeDLL, EntryPoint = "nim_sysmsg_reg_custom_notification_arc_cb", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern void nim_sysmsg_reg_custom_notification_arc_cb([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string  json_extension, CustomSysMsgArcDelegate cb, IntPtr user_data);
