...
namespace NIM
{
    namespace Friend
    {
        ...
        public class NIMFriendProfile : NimUtility.NimJsonObject<NIMFriendProfile>
        {
            ...
            ///被动的好友关系 
            /// </summary>
            [JsonProperty(PropertyName = "beflag", NullValueHandling = NullValueHandling.Ignore)]
            ...
            ///扩展数据 
            /// </summary>
            [JsonProperty(PropertyName = "bits", NullValueHandling = NullValueHandling.Ignore)]
            ...
            public string ExtensionalData { get; set; }

            ///// <summary>
            ///// 好友数据有效性，结合好友Key使用
            ///// </summary>
            //[JsonPropertyAttribute("msg_attach")]
            //public uint AvailableFlag { get; set; }
