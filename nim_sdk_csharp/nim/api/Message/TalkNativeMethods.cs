...
namespace NIM
{
    ...
    class TalkNativeMethods
    {
        ...
        [DllImport(NIMGlobal.NIMNativeDLL, EntryPoint = "nim_talk_reg_arc_cb", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        public static extern void nim_talk_reg_arc_cb([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(NimUtility.Utf8StringMarshaler))] string jsonExtension, IMMessageArcCallback cb, IntPtr user_data);
